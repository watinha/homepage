var KeyboardHandler = function (params, Helpers) {
    "use strict";
    var $public = {},
    ...
    $public.move_down = function (active_element) {
        ...
        if ($private.main_elements[next_index].className && Helpers.hasClass($private.main_elements[next_index], "open")) {
    ...
    $private.find_active = function (active_element) {
        ...
        for (i = 0; i < $private.main_elements.length; i = i + 1) {
            if (active_element && ($private.main_elements[i] === active_element || $private.main_elements[i] === active_element.parentNode)) {
                return i;
            }
        }
        return null;
